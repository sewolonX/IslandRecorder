...
internal sealed interface PrivilegedRuntime {
    ...
    data object SystemApp : Direct("SystemApp")

    data object UserService : Direct("UserService")
    ...
    data object ShizukuHooked : PrivilegedRuntime {
        ...
        override fun settingsBinder(reflect: ReflectionProvider, settingsClass: Class<*>): IBinder? {
    ...
    sealed class Direct(
        ...
        override fun settingsBinder(reflect: ReflectionProvider, settingsClass: Class<*>): IBinder? {
            Timber.tag(TAG).d("Getting Settings Binder in $name mode.")
            return reflect.resolveSettingsBinder(settingsClass)?.originalBinder
        }
