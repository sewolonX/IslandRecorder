...
class AudioEncoder(
    ...
    fun prepare() {
        try {
            ...
            Timber.d("Audio encoder initialized: ${sampleRate}Hz, $channelCount channels")
    ...
    fun encode(pcmData: ByteArray, length: Int, timestampUs: Long) {
        ...
        try {
            ...
            Timber.e(e, "Error encoding audio frame")
        }
    }
    ...
    fun getEncodedData(): Output {
        ...
        return when {
            ...
            outputBufferIndex == MediaCodec.INFO_OUTPUT_FORMAT_CHANGED -> {
                Timber.d("Audio output format changed: ${codec.outputFormat}")
